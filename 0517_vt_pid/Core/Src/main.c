...
extern int photo_sensor_flag_y__;
...
float input_encodor_X_GO = 34000 * 1.3;
float input_encodor_X_BACK = -34000 * 1.3;

float input_encodor_Y_GO = 34000 * 2;
float input_encodor_Y_BACK = -34000 * 2;

float targetS_X_GO=55;
float targetS_X_BACK=55;

float targetS_Y_GO = 55;
float targetS_Y_BACK = 55;
...
uint16_t ball_step=50;
uint16_t downpart_step=50;
...
//////////////////////////////////////////////////////////Y  VT
	...
	case '>':
			...
			down_part_UP(400*2, shaft_pulse_cycle);

			break;

		case '?':

			down_part_DOWN(400*2, shaft_pulse_cycle);
