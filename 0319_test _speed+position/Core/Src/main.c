...
extern int step_enable;
extern uint8_t rev10_flag;
extern uint8_t rev1_flag;
...
uint16_t pulse_step = 200 * 2;
uint16_t pulse_cycle = 850;
/* USER CODE END 0 */
