...
struct flag{
	...
	uint8_t downpart_high;
	uint8_t downpart_low;
...
#define BALL_MIN_Pin GPIO_PIN_2
#define BALL_MIN_GPIO_Port GPIOF
#define BALL_MIN_EXTI_IRQn EXTI2_IRQn
...
#define BALL_MAX_Pin GPIO_PIN_0
#define BALL_MAX_GPIO_Port GPIOD
#define BALL_MAX_EXTI_IRQn EXTI0_IRQn
